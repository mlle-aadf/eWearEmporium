...
<main>
    <div className="about-section">
        ...
        <div className="other-section">
            ...
            <br/>
            2.1. If you wish to purchase any product, you may be asked to supply certain information relevant to your Purchase including, without limitation, your credit card number, the expiration date of your credit card, your billing address, and your shipping information.
            <br/>
            <br/>
            2.2. You represent and warrant that: 
            <br/>(i) you have the legal right to use any credit card(s) or other payment method(s) in connection with any; 
            <br/>(ii) the information you supply to us is true, correct, and complete.
            <br/>
            <br/>
            ...
            <Bold>3. Content</Bold>
            <br/>
            3.1. Our Service allows you to post, link, store, share, and otherwise make available certain information, text, graphics or videos. You are responsible for the Content that you post on or through the Service, including its legality, reliability, and appropriateness.
            <br/>
            <br/>
            3.2. By posting Content on or through the Service, you represent and warrant that: 
            <br/>(i) the Content is yours (you own it) and/or you have the right to use it and the right to grant us the rights and license as provided in these Terms; 
            <br/>(ii) and that the posting of your Content on or through the Service does not violate the privacy rights, publicity rights, copyrights, contract rights, or any other rights of any person or entity.
            <br/>
            <br/>
            ...
            <br/>
            7.1. If you have any questions about these Terms, please contact us by clicking the following button:
            <br/>
            <br/>
