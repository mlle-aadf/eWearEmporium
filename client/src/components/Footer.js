        ...
        <div className="footer-pt1">
          ...
          <div className="colTwo">
            ...
            <ul>
              ...
              <Link to="/contact" className="footer-link"><li>Contact Us</li></Link>
              <Link to="/about" className="footer-link"><li>Frequently Asked Questions</li></Link>
              <Link to="/about" className="footer-link"><li>Terms and Conditions</li></Link>
            </ul>
          </div>
          <br />
          <br/>
